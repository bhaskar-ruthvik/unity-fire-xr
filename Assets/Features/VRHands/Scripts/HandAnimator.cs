...
public class HandAnimator : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        xrPokeInteractor.uiHoverEntered.AddListener(ActivatedUIHandPose);
        xrPokeInteractor.uiHoverExited.AddListener(DeactivatedUIHandPose);
    }

    private void ActivatedUIHandPose(UIHoverEventArgs arg0)
    {
        isUIAnimationPlaying = true;
        SetFingerAnimationValues(uiFingers, 1);
        AnimateActionInput(uiFingers);
    }
    private void DeactivatedUIHandPose(UIHoverEventArgs arg0)
    {
